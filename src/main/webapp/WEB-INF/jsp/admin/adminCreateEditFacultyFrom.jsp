                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="/controller?command=createNewFacultyForm&action=${action}&sessionLocale=en">
                                        <fmt:message key="navbar.English"/></a>
                                    <a class="dropdown-item" href="/controller?command=createNewFacultyForm&action=${action}&sessionLocale=uk">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/controller" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label for="name_en" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.name.en"/>
                                            </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="name_uk" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.name.uk"/>
                                           </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="description_en" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.description.en"/>
                                            </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="description_uk" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.description.uk"/>
                                            </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="totalCapacity" class="col-md-4 col-form-label text-md-right"><fmt:message key="admin.total_capacity"/>
                                           </label>
                                        <div class="col-md-6">
                                            <input type="number" id="totalCapacity" class="form-control"
                                                   name="totalCapacity" required>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="requiredSubject1_en" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject1_en"/>
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject1_en" class="form-control"
                                                   name="requiredSubject1_en" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="requiredSubject1_uk" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject1_uk"/>
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject1_uk" class="form-control"
                                                   name="requiredSubject1_uk" required>
                                        </div>
                                    </div>


                                    <div class="form-group row">
                                        <label for="requiredSubject2_en" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject2_en"/>
                                          </label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject2_en" class="form-control"
                                                   name="requiredSubject2_en" required>
                                        </div>
                                    </div>


                                    <div class="form-group row">
                                        <label for="requiredSubject2_uk" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject2_uk"/></label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject2_uk" class="form-control"
                                                   name="requiredSubject2_uk" required>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="requiredSubject3_en" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject3_en"/></label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject3_en" class="form-control"
                                                   name="requiredSubject3_en" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="requiredSubject3_uk" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject3_uk"/> </label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject3_uk" class="form-control"
                                                   name="requiredSubject3_uk" required>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="controller" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="name_uk" class="form-control" name="name_en"
                                    ...
                                    <div class="form-group row">
                                        <label for="totalCapacity" class="col-md-4 col-form-label text-md-right"><fmt:message key="admin.budget_capacity"/></label>
                                        <div class="col-md-6">
                                            <input type="number" id="totalCapacity" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject1_en" class="form-control"
                                                   name="requiredSubject1" value="${faculty.requiredSubject1En}"
                                                   required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="requiredSubject1_uk" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject1_uk"/> </label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject1_uk" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <label for="requiredSubject2_en" class="col-md-4 col-form-label text-md-right"><fmt:message key="faculty.required_subject2_en"/></label>
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject2_en" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="requiredSubject3_en" class="form-control"
                                                   name="requiredSubject3" value="${faculty.requiredSubject3En}"
                                                   required>
                                        </div>
                                    </div>
