...
public final class Constants {
    ...
    public static final String SQL_INSERT_ADMISSION_REQUEST = "INSERT INTO admission_request " +
            ...
            "Values(?,?,?,?,?,?);";
    public static final String SQL_FIND_ADMISSION_REQUEST_BY_ID = "SELECT cp.id, cp.address, cp.city, cp.email, cp.first_name, cp.last_name, cp.phone_number, cp.region, cp.school, cp.candidate_id, " +
    ...
    public static final String SQL_INSERT_CANDIDATE_PROFILE="INSERT INTO candidate_profile(first_name,last_name,email,address,city,region,school,phone_number,candidate_id)" +
            " Values(?,?,?,?,?,?,?,?,?)";
    ...
    public static final String SQL_UPDATE_CANDIDATE_PROFILE ="UPDATE candidate_profile SET first_name=?,last_name=?,email=?,address=?,city=?,region=?,school=?,phone_number=? " +
            "WHERE id=?";
    public static final String SQL_FIND_CANDIDATE_PROFILE = "SELECT cp.id, address, city, email, first_name, last_name, phone_number, region, school, candidate_id From candidate_profile cp Where candidate_id=?";
